...
void WaitingVehicles::permitEntryToFirstInQueue()
{
    ...
    // std::shared_ptr<Vehicle> vehicle = _vehicles.front(); // unused
    std::promise<void>& prms = _promises.front(); // get reference so don't increment shared ptr
    prms.set_value(); // void so no value
