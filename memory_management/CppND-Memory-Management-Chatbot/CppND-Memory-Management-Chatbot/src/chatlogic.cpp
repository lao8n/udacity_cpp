                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            (edge.get())->SetChildNode((*childNode).get()); // dereference iterator and then get node * with get()
                            ...
                            ((*childNode).get())->AddEdgeToParentNode(edge.get()); // child just has reference
                            ((*parentNode).get())->AddEdgeToChildNode(std::move(edge)); // parent owns
                        }
