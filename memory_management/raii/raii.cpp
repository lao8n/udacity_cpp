// resource acquisition is initialization = safely access resources by wrapping a manager class around the 
// handle which is initialized when the resource is acquired and released when the resource is deleted.
// problem when copying however
